...
echo ""
echo "🔓 Manual Decryption Commands:"
echo "================================"
echo ""
echo "1. Get event by ID:"
echo "   EVENT_ID=\"596c97ea3b1dfd27af3613a2e389d04eb50e5596e78a3e98ea45e4b20bfd7b58\""
echo "   EVENT=\$(nak get-event --event-id \"\$EVENT_ID\" wss://relay.damus.io wss://nos.lol wss://relay.nostr.band wss://relay.primal.net)"
echo ""
echo "2. Extract encrypted content and sender pubkey:"
echo "   ENCRYPTED_CONTENT=\$(echo \"\$EVENT\" | jq -r '.content')"
echo "   SENDER_PUBKEY_HEX=\$(echo \"\$EVENT\" | jq -r '.pubkey')"
echo ""
echo "3. Decrypt the message:"
echo "   nak decrypt --nip04 --sec \"\$USER_NSEC\" --sender-pubkey \"\$SENDER_PUBKEY_HEX\" \"\$ENCRYPTED_CONTENT\""
echo ""
echo "4. One-liner command:"
echo "   EVENT_ID=\"596c97ea3b1dfd27af3613a2e389d04eb50e5596e78a3e98ea45e4b20bfd7b58\" && EVENT=\$(nak get-event --event-id \"\$EVENT_ID\" wss://relay.damus.io wss://nos.lol wss://relay.nostr.band wss://relay.primal.net) && ENCRYPTED_CONTENT=\$(echo \"\$EVENT\" | jq -r '.content') && SENDER_PUBKEY_HEX=\$(echo \"\$EVENT\" | jq -r '.pubkey') && nak decrypt --nip04 --sec \"\$USER_NSEC\" --sender-pubkey \"\$SENDER_PUBKEY_HEX\" \"\$ENCRYPTED_CONTENT\""
echo ""
echo "📋 Expected Response Format:"
echo "{\"pod_npub\":\"npub16h7fatpsgcmxx2c89xmtl57yv7yan789yqcmhpezndwmqwv5lkksljzr2k\",\"node_port\":1869,\"expires_at\":\"2025-09-29T00:19:14.412193496+00:00\",\"cpu_millicores\":2000,\"memory_mb\":2048,\"pod_spec_name\":\"Standard\",\"pod_spec_description\":\"Standard VPS - 2 CPU cores, 2GB RAM\",\"instructions\":[\"🚀 SSH access available:\",\"\",\"Direct access (no kubectl needed):\",\"   ssh -o PreferredAuthentications=password -o PubkeyAuthentication=no alice@37.27.165.100 -p 1869\",\"\",\"⚠️  Pod expires at:\",\"   2025-09-29 00:19:14 UTC\",\"\",\"📋 Pod Details:\",\"   Pod NPUB: npub16h7fatpsgcmxx2c89xmtl57yv7yan789yqcmhpezndwmqwv5lkksljzr2k\",\"   Specification: Standard (Standard VPS - 2 CPU cores, 2GB RAM)\",\"   CPU: 2000 millicores\",\"   Memory: 2048 MB\",\"   Duration: 1000 seconds\"]}"
echo ""
