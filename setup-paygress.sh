...
echo "2. Create your environment file: cp ~/paygress/.env.template ~/paygress/.env"
echo "3. Edit ~/paygress/.env with your Nostr private key and server IP"
echo "4. Start the service: sudo systemctl start paygress"
echo "5. Check status: sudo systemctl status paygress"
echo ""
echo "🌐 Your Paygress service will be available in Nostr mode"
